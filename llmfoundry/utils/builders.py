    ...
    def _validate_cfg(icl_cfg):
        ...
        if 'metric_names' not in icl_cfg:
            if icl_cfg.icl_task_type == 'language_modeling':
                ...
                icl_cfg.metric_names = ['InContextLearningToxicityAccuracy']
                icl_cfg.icl_task_type = 'model_based'
            elif icl_cfg.icl_task_type == 'relevance':
                icl_cfg.metric_names = ['InContextLearningRelevanceAccuracy']
                icl_cfg.icl_task_type = 'model_based'
            elif icl_cfg.icl_task_type == 'readability':
                icl_cfg.metric_names = ['InContextLearningFleschKincaidAccuracy']
                icl_cfg.icl_task_type = 'model_based'
            else:
                raise ValueError(
